...
export default function Produit() {
  const produit = {
    docsList: ['cycle-module2-fondamentaux','cycle-module3-qualite','cycle-module4-visualisation','cartes-fresque-opendata'],
    ...
    Le premier module est une fresque des données ouvertes.
