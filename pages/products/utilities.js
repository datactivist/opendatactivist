...
export default function Produit() {
  const produit = {
    docsList: ['utilities-asset-management', 'utilities-copper-switchoff', 'utilities-plan-corps-rue-simplifie', 'utilities-transition-energetique'],
    ...
    Nous avons rassemblés les retours d'expérience les plus significatifs ci-dessous autour de thèmes précis :
    <ul>
    ...
    Notre exprience s'établit entre des outils conçus puis maintenus sur ces sujets et au gré des missions pour nos clients dont nous avons pu publier certaines ressources pour notre propre compte.
    `,
