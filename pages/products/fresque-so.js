...
export default function Produit() {
  const produit = {
    ...
    liens: [
        {url: 'mailto:hello@datactivist.coop?subject=Demande d\'informations - fresque science ouverte', texte: '✉️ Nous contacter pour en savoir plus'},
        {url: 'https://open.datactivist.coop/docs/cartes-fresque-so', texte: '🖨️ Imprimez le jeu'}
      ]
  }
