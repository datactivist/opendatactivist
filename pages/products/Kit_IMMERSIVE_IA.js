...
export default function Produit() {
  const produit = {
    ...
    <li>Ce qui rend IMMERSION IA unique, c'est sa capacité à créer une culture partagée. </li>
	<li>Le format s'adapte aussi bien à un groupe de 10 personnes qu'à une soixantaine de participants, <b>sans nécessiter de connaissances techniques préalables</b>.</li>
	<li>L'hétérogénéité des profils est même un atout, enrichissant les échanges et <b>favorisant l'identification collective de cas d'usage pertinents pour votre organisation</b>.</li>
