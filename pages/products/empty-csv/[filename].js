...
import EmptyCsv from '../../../components/stories/EmptyCsv';
...
export default function SearchCsv() {
  ...
  return (
    <Layout>
        <br></br>
        <Button onClick={generateIframeCode} variant="contained">Intégrer cette analyse</Button>
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle>Code d'intégration</DialogTitle>
          <DialogContent>
            <TextField value={iframeCode} fullWidth={true} multiline={true} rows={6} />
