...
export default function Produit() {
  const produit = {
    ...
    nom: 'EXCOM : évaluer les externalités des commerces de proximité',
    ...
    partnersIds: ['paris-commerces', 'altavia-foundation', 'urbanis-amenagement', 'urbanis-fondation', 'metropole-rouen', 'institut-recherche'],
    liens: [
