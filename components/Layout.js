      ...
      >
        ...
        {windowWidth > 768 ? (
          ...
          >
            ...
            <option className={styles.option} value="/docs">
              Publications
            </option>
            <option className={styles.option} value="/products">
              Produits
            </option>
            <option className={styles.option} value="/references">
              Références
            </option>
            <option className={styles.option} value="/recherche">
              Recherche
            </option>
            <option className={styles.option} value="/equipe">
              Equipe
            </option>
            <option className={styles.option} value="/blog">
              Blog
            </option>
            <option className={styles.option} value="/presse">
              Presse
            </option>
          </select>
        )}
