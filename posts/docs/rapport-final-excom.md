Le projet EXCOM a été lancé avec pour objectif de nommer et de quantifier ces effets alors peu visibles dans leur globalité.

Ce rapport final met en valeur les contributions positives des commerces de proximité, éclairant ainsi l’ensemble de la valeur créée par ces entrepreneurs. Il offre des éléments concrets pour aider les collectivités locales et les législateurs à mieux comprendre et valoriser leur rôle dans le développement des territoires.
...
L'intégralité des résultats sont à retrouver [ici](https://datactivist.coop/excom/rapport/Rapport.html)

# Ressources complémentaires

%%Docs:flyer-excom,methodo-excom,super-commerces-excom,commerce-etages-excom%%
