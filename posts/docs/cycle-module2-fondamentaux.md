> Datactivist a construit un cycle d’acculturation et de formation à la donnée, qui permet aux participants d’acquérir une autonomie dans l’ouverture des données.
