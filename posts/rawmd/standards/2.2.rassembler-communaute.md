...
#### 👉 [Ressource clé : déclarer son schéma](https://schema.data.gouv.fr/contribuer.html)
...
#### 👉 [Ressource clé : une présentation de l'intérêt des standards](https://open.datactivist.coop/docs/standards-territoires)
...
#### 👉 [Ressource clé : le modèle des cercles concentriques](https://nextcloud.datactivist.coop/s/qq9YsEkjpoENzyM)
